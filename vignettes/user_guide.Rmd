...
needs to be given to R. To do this, the `DTM_SUBSCRIPTION_KEY` environment variable needs to be defined as the subscription key. There are three main ways to do this, as described below.
