...
For information on the other parameters and indeed all functions in the `dtmapi`, [see the documentation for any of the functions here.](https://displacement-tracking-matrix.github.io/dtmapi-R/reference/)
...
available [here](https://displacement-tracking-matrix.github.io/dtmapi-R/).
